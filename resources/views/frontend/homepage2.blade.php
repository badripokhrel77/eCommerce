        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="{{url('single_product')}}"><img src="img/products/product-img-1.jpg"
                                    alt=""></a>
                        </div>
                        <h3>Strawberry</h3>
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="{{url('single_product')}}"><img src="img/products/product-img-2.jpg"
                                    alt=""></a>
                        </div>
                        <h3>Berry</h3>
                ...
                <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="{{url('single_product')}}"><img src="img/products/product-img-3.jpg"
                                    alt=""></a>
                        </div>
                        <h3>Lemon</h3>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-news">
                        <a href="{{url('singlr_news')}}">
                            <div class="latest-news-bg news-bg-1"></div>
                        </a>
                        <div class="news-text-box">
                            <h3><a href="{{url('single_news')}}">You will vainly look for fruit on it in autumn.</a></h3>
                            <p class="blog-meta">
                            ...
                            <a href="{{url('single_news')}}" class="read-more-btn">read more <i
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-news">
                        <a href="{{url('single_news')}}">
                            <div class="latest-news-bg news-bg-2"></div>
                        </a>
                        <div class="news-text-box">
                            <h3><a href="{{url('single_news')}}">A man's worth has its season, like tomato.</a></h3>
                            <p class="blog-meta">
                                <span class="author"><i class="fas fa-user"></i> Admin</span>
                                <span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
                            </p>
                ...
                <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
                    <div class="single-latest-news">
                        ...
                        <div class="news-text-box">
                            <h3><a href="{{url('single_news')}}">Good thoughts bear good fresh juicy fruit.</a></h3>
                            <p class="blog-meta">
                                <span class="author"><i class="fas fa-user"></i> Admin</span>
                                <span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
                            </p>
