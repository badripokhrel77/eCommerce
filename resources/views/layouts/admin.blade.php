...
<head>
    ...
    <title>@yield('title', 'FruitsKha')</title>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="./index.html" class="text-nowrap logo-img">
                        <img src="../assets/images/logos/logo.png" alt="" style="width:200px; height:90px;" />
                    </a>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ url('admin/product') }}" aria-expanded="false">
                                <span>
                                    <iconify-icon icon="ic:round-shopping-cart" class="fs-6"></iconify-icon>
        ...
        <div class="body-wrapper">
            ...
            <header class="app-header">
                {{-- <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #19383d;"> --}}
                                    ...
                                    <div class="message-body">
                                        ...
                                        <form action="{{ url('logout') }}" method="POST">
                                            ...
                                            <a href="#" onclick="this.closest('form').submit();"
                                                class="btn btn-outline-primary mx-3 mt-0 d-block">Logout</a>
